...
{
    // mClientManager.deploy(base::msq::Msq_CelNetwork_Client, [this, status](std::string mqName) {
    //     std::lock_guard<std::mutex> lock(mMutex);
    //     mMqSender.startMsq(base::msq::SIM_CelNetwork_RespChangeCellulatr);
...
{
    // mClientManager.deploy(base::msq::Msq_PSTN_Client, [this, status, number](std::string mqName) {
    //     std::lock_guard<std::mutex> lock(mMutex);
...
{
    // mClientManager.deploy(base::msq::Msq_PSTN_Client, [this, number, name, avatar](std::string mqName) {
    //     std::lock_guard<std::mutex> lock(mMutex);
...
{
    // mClientManager.deploy(base::msq::Msq_PSTN_Client, [this, time](std::string mqName) {
    //     std::lock_guard<std::mutex> lock(mMutex);
